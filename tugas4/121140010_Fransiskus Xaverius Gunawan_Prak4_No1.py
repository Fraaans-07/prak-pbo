...
class RAM(Komputer):
    def __init__(self, merk, jenis, harga, capacity):
        super().__init__('RAM ' + capacity, 'Memory', harga, merk)
        self.capacity = capacity

class HDD(Komputer):
    def __init__(self, merk, jenis, harga, capacity, rpm):
        super().__init__('HDD ' + capacity, jenis, harga, merk)
        self.capacity = capacity
        self.rpm = rpm

class VGA(Komputer):
    def __init__(self, merk, jenis, harga, capacity):
        super().__init__('VGA ' + capacity, jenis, harga, merk)
        self.capacity = capacity

class PSU(Komputer):
    def __init__(self, merk, nama, harga, daya):
        super().__init__(nama, 'Power Supply', harga, merk)
        self.daya = daya
